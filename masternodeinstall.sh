...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='eros.conf'
CONFIGFOLDER='/root/.eros'
COIN_DAEMON='erosd'
COIN_CLI='eros-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/ErosCore/ErosCore/releases/download/v1.0.0/eroscore-1.0.0-linux64.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='erosd'
COIN_EXPLORER='http://explorer.erosblockchain.com'
COIN_PORT=18325
RPC_PORT=18324
